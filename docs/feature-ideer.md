...
Prioriteret idékatalog til videreudvikling. ✅ = allerede implementeret.
...
2. **Bødehistorik pr. møde i medlemsprofilen** — filtrér historikken efter klubår.
...
14. **Læse-adgang til alle medlemmer** — del et link hvor medlemmer kan SE ligaen men ikke registrere (er delvist muligt allerede via artifact-deling).
...
19. **Papirkurv/fortryd for slettede møder og medlemmer** — blødt slet med 30 dages frist i stedet for permanent sletning.
