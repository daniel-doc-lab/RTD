...
## Status efter implementeringen (1. sep. 2026)

Implementeret: **21, 22, 23, 25, 27, 28, 31** samt medlemskab pr. klubår, medlemsfiltre, prospects og delevejledning.

Udestående fra denne runde: 24 (tastaturbetjening ud over fortryd/gendan), 26 (restancealder), 29 (bøde under protest), 30 (gentagelsestakst), 32 (mødeskabelon ved nyt klubår), 33 (backup-påmindelse), 34 (flettende import), 35 (papir-reserveliste).
